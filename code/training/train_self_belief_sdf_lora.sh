...
OUTPUT_DIR="$PROJECT_DIR/data/finetunes/self_belief_002_sdf_lora"
...

{
  ...
  "$PYTHON_BIN" -c 'import torch,transformers,peft,datasets; print(f"torch={torch.__version__} transformers={transformers.__version__} peft={peft.__version__} datasets={datasets.__version__}")'
